...
import (
	...
	"github.com/psimoesSsimoes/twirp/internal/gen"
	"github.com/psimoesSsimoes/twirp/internal/gen/stringutils"
	"github.com/psimoesSsimoes/twirp/internal/gen/typemap"
)
...
func (t *twirp) generateFileHeader(file *descriptor.FileDescriptorProto) {
	...
	if t.filesHandled == 0 {
		...
		t.P("This code was generated with github.com/psimoesSsimoes/twirp/protoc-gen-twirp ", gen.Version, ".")
		t.P()
...
func (t *twirp) generateImports(file *descriptor.FileDescriptorProto) {
	...
	t.P(`import `, t.pkgs["twirp"], ` "github.com/psimoesSsimoes/twirp"`)
	t.P(`import `, t.pkgs["ctxsetters"], ` "github.com/psimoesSsimoes/twirp/ctxsetters"`)
	t.P()
